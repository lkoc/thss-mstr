...
Entre los años 2002 y 2011, lejos de reducirce, las emisiones de carbono han ido en aumento  con una ratio anual de crecimiento de $3.2\ \%$ en promedio \citep[p.~50]{stocker_climate_2013}. En el año 2017, el crecimiento ha sid oestimado en $1.8\ \%$ \citep[p.~2]{peters_towards_2017} . Una gran proporción de estas emisiones provienen de la industria de la energía, de tal modo que existe la necesidad de llevar a cabo una profunda descarbonización para mitigar los efectos del calentamiento global mediante  la generación de electricidad con recursos energéticos renovables que reemplacen  las actuales fuentes que utilizan combustibles fósiles \citep[p.~3]{duan_modeling_2020}.

Los proyectos de generación renovables, se desarrollan no sin problemas en nuestro País. Los proyectos construido y en desarrollo, en el corto plazo, están limitados a los sitios con recurso de alta calidad (el Sur para el Sol y el centro y norte para Viento). De otros lado, el desarrollo de estos proyectos puede llevar a conflictos.
En otros paises, los proyectos eólicos, por ejemplo, han tenido oposición debido a la intrusión visual, contaminación por ruido, daño a las aves, entre otras razones \citep[p.~282]{moriarty_energy_2018}.
